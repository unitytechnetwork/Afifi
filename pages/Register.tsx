...
const Register: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    name: '', staffId: '', email: '', role: 'Technician' as 'Technician' | 'Supervisor', pin: '', confirmPin: ''
  });
  ...
  const finalizeRegistration = () => {
    ...
    registry.push({ ...formData, avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=${formData.staffId}`, status: 'online' });
